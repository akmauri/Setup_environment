...
1. **task-2-5.6**: Implement function to refresh LinkedIn long-lived token [medium]
2. **task-2-5.7**: Implement function to get LinkedIn personal profile information [medium]
3. **task-2-5.8**: Implement function to get LinkedIn company pages for user [medium]
4. **task-2-5.9**: Implement function to get LinkedIn company page information [medium]
5. **task-2-5.12**: Support connecting personal LinkedIn profile [medium]
...
2. **For Each Task (in order, respecting dependencies):**
   ...
   g. **Commit**: Commit with message `[dev-oauth-2] [task-2-5.6] Description`
...
Begin with your first task: **task-2-5.6** - Implement function to refresh LinkedIn long-lived token
